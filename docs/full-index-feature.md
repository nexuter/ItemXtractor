...
python script/extractor.py --filing 10-K --year 2024 --extract-structure
```
...
python script/extractor.py --filing 10-K --year 2024 --items 1
...
python script/extractor.py --filing 10-K --year 2024 --workers 16

# Separate structure extraction after download
python script/extractor.py --filing 10-K --year 2024 --extract-structure --workers 16
```
